...
public class Hotelcontroller {
	...
	@ApiOperation(value = "get hotel by id",notes = "api is used to get hotel details based on hotel id")
	@ApiResponses(value = {@ApiResponse(code = 302,message = "succesfully found hotel"),
			@ApiResponse(code = 404,message = "hotel not found give proper hotel id")})
	@GetMapping
